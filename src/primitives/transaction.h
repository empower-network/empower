...
static const uint8_t EMPOWER_BLOCK_VERSION = 0xA0;
static const uint8_t EMPOWER_TXN_VERSION = 0xA0;
static const uint8_t MAX_EMPOWER_TXN_VERSION = 0xBF;
...
inline bool IsEmpowerTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= EMPOWER_TXN_VERSION;
}
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsEmpowerTxVersion(tx.nVersion)) {
...
public:
    ...
    static const int32_t CURRENT_EMPOWER_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_EMPOWER_VERSION=0xA0;
...
public:
    ...
    bool IsEmpowerVersion() const {
        return IsEmpowerTxVersion(nVersion);
    }
    ...
    {
        return IsEmpowerTxVersion(nVersion) ? vpout.size() : vout.size();
    }
