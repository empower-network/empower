...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendmpwrtoblind", 1, "amount" },
    { "sendmpwrtoblind", 4, "subtractfeefromamount" },
    { "sendmpwrtoanon", 1, "amount" },
    { "sendmpwrtoanon", 4, "subtractfeefromamount" },

    { "sendblindtompwr", 1, "amount" },
    { "sendblindtompwr", 4, "subtractfeefromamount" },
    ...
    { "sendanontompwr", 1, "amount" },
    { "sendanontompwr", 4, "subtractfeefromamount" },
    { "sendanontompwr", 6, "ringsize" },
    { "sendanontompwr", 7, "inputs_per_sig" },
    ...
    { "createrawmpwrtransaction", 0, "inputs" },
    { "createrawmpwrtransaction", 1, "outputs" },
    { "createrawmpwrtransaction", 2, "locktime" },
    { "createrawmpwrtransaction", 3, "replaceable" },
